...
DEFAULT_MANIFEST: List[ModelSpec] = [
    ...
    ModelSpec(
        key="ltx2_checkpoint_main",
        repo_id=os.environ.get("MILIMO_LTX2_CHECKPOINT_REPO", "Lightricks/LTX-2"),
        filename=os.environ.get("MILIMO_LTX2_CHECKPOINT_FILE", "ltx-2-19b-distilled.safetensors"),
        out_rel_path="ltx2/ltx-2-19b-distilled.safetensors",
        sha256=os.environ.get("MILIMO_LTX2_CHECKPOINT_SHA256") or None,
        quant="bf16",
        required_for_modes=("high", "low", "cpu"),
    ),
    ModelSpec(
        key="ltx2_checkpoint_fp8",
        repo_id=os.environ.get("MILIMO_LTX2_CHECKPOINT_REPO", "Lightricks/LTX-2"),
        filename=os.environ.get("MILIMO_LTX2_CHECKPOINT_FP8_FILE", "ltx-2-19b-distilled-fp8.safetensors"),
        out_rel_path="ltx2/ltx-2-19b-distilled-fp8.safetensors",
        sha256=os.environ.get("MILIMO_LTX2_CHECKPOINT_FP8_SHA256") or None,
        quant="fp8",
        required_for_modes=("high", "low", "cpu"),
    ),
    ModelSpec(
        key="ltx2_distilled_lora",
        repo_id=os.environ.get("MILIMO_LTX2_CHECKPOINT_REPO", "Lightricks/LTX-2"),
        filename=os.environ.get("MILIMO_LTX2_DISTILLED_LORA_FILE", "ltx-2-19b-distilled-lora-384.safetensors"),
        out_rel_path="ltx2/ltx-2-19b-distilled-lora-384.safetensors",
        sha256=os.environ.get("MILIMO_LTX2_DISTILLED_LORA_SHA256") or None,
        quant="bf16",
        required_for_modes=("high", "low", "cpu"),
    ),
    ModelSpec(
        key="ltx2_spatial_upscaler",
        repo_id=os.environ.get("MILIMO_LTX2_CHECKPOINT_REPO", "Lightricks/LTX-2"),
        filename=os.environ.get("MILIMO_LTX2_SPATIAL_UPSCALER_FILE", "ltx-2-spatial-upscaler-x2-1.0.safetensors"),
        out_rel_path="ltx2/ltx-2-spatial-upscaler-x2-1.0.safetensors",
        sha256=os.environ.get("MILIMO_LTX2_SPATIAL_UPSCALER_SHA256") or None,
        quant="bf16",
        required_for_modes=("high", "low", "cpu"),
    ),
    ModelSpec(
        key="ltx2_temporal_upscaler",
        repo_id=os.environ.get("MILIMO_LTX2_CHECKPOINT_REPO", "Lightricks/LTX-2"),
        filename=os.environ.get("MILIMO_LTX2_TEMPORAL_UPSCALER_FILE", "ltx-2-temporal-upscaler-x2-1.0.safetensors"),
        out_rel_path="ltx2/ltx-2-temporal-upscaler-x2-1.0.safetensors",
        sha256=os.environ.get("MILIMO_LTX2_TEMPORAL_UPSCALER_SHA256") or None,
        quant="bf16",
        required_for_modes=("high", "low", "cpu"),
    ),
    ModelSpec(
